...
model = dict(
    ...
    test_cfg=dict(
        pts=dict(
            ...
            post_center_limit_range=[-80, -80, -5, 80, 80, 3],
            max_per_img=500,
            max_pool_nms=False,
            min_radius=[4, 12, 3, 1],
            score_threshold=0.1,
...
data_root = '/data/dataset/deeproute/'
...
log_level = 'INFO'
work_dir = './work_dirs/new_cp_aug_secfpn_80e'
#load_from = './work_dirs/pp_secfpn_80e/epoch_76.pth'
load_from = None
resume_from = None
workflow = [('train', 1)]
