...
# To extract instances from the training data 
```python
cd tools/data_converter
python deeproute_data_aug.py
```


# To save the augmented data

To save the augmented data in .npy files and the data info in a .pkl file
```python
cd tools/data_converter
python deeproute_generate_aug_data.py
```

To save the augmented data in .bin files and the data info in .txt files
```python
cd tools/data_converter
